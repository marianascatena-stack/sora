// =========================================================
// SORA — autenticação (demo com localStorage)
// Não é um backend real: serve pra dar comportamento
// completo de login/cadastro sem precisar de servidor.
// =========================================================
...
// recalcula a posição do indicador se a janela for redimensionada
...
// posiciona o indicador corretamente já na carga da página
...
// Se já existe sessão ativa, pula direto pra vitrine
